...
public class ProgressController {
    ...
    public ResponseEntity<List<ProgressResponse>> getProgressByPlanId(@PathVariable("plan_id") Long planId) {
        return ResponseEntity.ok(progressService.getProgressByPlanId(planId));
    }
}